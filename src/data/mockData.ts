...
export const affiliateProducts = [
  ...
  },
  {
    ...
    retailer: "Flipkart",
    affiliateLink: "https://flipkart.com",
    description: "Make a statement with this Harry Styles-inspired sequin blazer."
  }
];
...
export const analyticsData = {
  topPosts: [
    { id: "outfit-2", title: "NYC Street Style in Oversized Coat", views: 1243, clicks: 89, revenue: 156.78 },
    { id: "outfit-1", title: "Met Gala 2023 Red Carpet Look", views: 1056, clicks: 72, revenue: 127.35 },
    { id: "outfit-3", title: "Grammy Performance Flared Jumpsuit", views: 987, clicks: 68, revenue: 102.45 },
    { id: "outfit-6", title: "Paris Fashion Week Front Row Look", views: 856, clicks: 61, revenue: 95.20 },
    { id: "outfit-5", title: "Cannes Film Festival Suit Moment", views: 712, clicks: 48, revenue: 75.60 },
  ],
  monthlyStats: [
    { month: "Jan", views: 5200, clicks: 312, revenue: 415.75 },
    { month: "Feb", views: 6100, clicks: 385, revenue: 520.30 },
    { month: "Mar", views: 7300, clicks: 462, revenue: 615.89 },
    { month: "Apr", views: 6800, clicks: 429, revenue: 575.45 },
    { month: "May", views: 7500, clicks: 487, revenue: 645.20 },
    { month: "Jun", views: 8200, clicks: 531, revenue: 710.35 },
  ],
  retailerPerformance: [
    { retailer: "Amazon", clicks: 523, revenue: 875.45 },
    { retailer: "Myntra", clicks: 387, revenue: 625.30 },
...
// Tags and categories
export const tags = [
  "red carpet", "street style", "casual", "formal", "designer", 
  "performance", "gala", "awards", "fashion week", "premiere", 
  "interview", "vacation", "airport", "party", "daytime",
  "evening wear", "accessories", "vintage", "sustainable", "custom"
];

export const categories = [
  "Fashion Trends", "Celebrity Style", "Budget Fashion", "Fashion History",
  "Shopping Guides", "Style Tips", "Seasonal Fashion", "Fashion News"
];

export const occasions = [
  "Red Carpet", "Street Style", "Performance", "Interview", "Travel",
  "Film Festival", "Fashion Week", "Premiere", "Award Show", "Party"
];
